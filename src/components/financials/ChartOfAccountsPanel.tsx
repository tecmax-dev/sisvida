...
export function ChartOfAccountsPanel({ clinicId }: ChartOfAccountsPanelProps) {
  ...
  const { data: accounts = [], isLoading } = useQuery({
    queryKey: ["chart-of-accounts", clinicId],
    queryFn: async () => {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["chart-of-accounts", clinicId] });
