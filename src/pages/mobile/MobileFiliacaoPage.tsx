...
import { Loader2, CheckCircle2, AlertCircle, User, Briefcase, MapPin, Phone, CreditCard, FileText, Users, Shield } from "lucide-react";
      ...
      <MobileLayout showBottomNav={false}>
        <div className="flex items-center justify-center min-h-[60vh] p-4">
          <Card className="p-6 text-center">
            ...
            <p className="text-gray-600">O sindicato não está disponível no momento.</p>
          </Card>
        </div>
      </MobileLayout>
    );
